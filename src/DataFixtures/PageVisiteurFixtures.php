...
class PageVisiteurFixtures extends Fixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        <h2>Monstre</h2>
        <P>Ce sont les habitants de la fFosse. Il y en a de toutes les sortes, notamment à cause du courant, qui permet à la lumière de pénétrer très profondément dans la Fosse et donc de recréer des habitats entiers propores à leur croissance.</p>
        <h2>Chevalement</h2>
        ...
        <h2>Évolution</h2>
        <p>Au fur et à mesure des vombats, vos hôtes vont gagner en expérience et évoluer, mais aussi vous aller accéder à plus d'hôtes, qui vous permettront de faire plusieurs combats en parallèle.</p>
        <p>Avwec votre progression, vous allez pouvoir accéder à des niveaux différents de la Fosse, qui mettront plus de temps à atteindre, mais aussi rapporteront bien plus que les niveaux proches de la surface.</p>
        HTML
        ];
        $pages["PG_team"] = [
            "titre" => "Team", "contenu" =>
