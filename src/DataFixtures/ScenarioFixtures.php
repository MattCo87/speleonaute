...
class ScenarioFixtures extends Fixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $scenarios = array();
        // Create the entries
        $scenarios["SCENAR_nueenuisible"] = ["nom" => "nuée de nuisibles (1000 reputation)", "description" => "lorem ipsum", "recompense" => 500, "lienFormation" => "FORM_Nuisibles1"];
        ...
        $scenarios["SCENAR_nueeinfini"] = ["nom" => "nuée infini (3000 reputation)", "description" => "lorem ipsum", "recompense" => 40, "lienFormation" => "FORM_Infini5"];
