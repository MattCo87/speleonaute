 ...
 */
final class Version20220324151023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__creature_formation AS SELECT id, localisation, strategie FROM creature_formation');
        ...
        $this->addSql('INSERT INTO creature_formation (id, localisation, strategie) SELECT id, localisation, strategie FROM __temp__creature_formation');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__creature_formation AS SELECT id, localisation, strategie FROM creature_formation');
        $this->addSql('DROP TABLE creature_formation');
        $this->addSql('CREATE TABLE creature_formation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, localisation INTEGER DEFAULT NULL, strategie INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO creature_formation (id, localisation, strategie) SELECT id, localisation, strategie FROM __temp__creature_formation');
        $this->addSql('DROP TABLE __temp__creature_formation');
        $this->addSql('DROP INDEX IDX_7CE748AA76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__reset_password_request AS SELECT id, user_id, selector, hashed_token, requested_at, expires_at FROM reset_password_request');
