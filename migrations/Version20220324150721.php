 ...
 */
final class Version20220324150721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__statistique_modele AS SELECT id, valeur_min, valeur_max, valeur_niv FROM statistique_modele');
        ...
        $this->addSql('INSERT INTO statistique_modele (id, valeur_min, valeur_max, valeur_niv) SELECT id, valeur_min, valeur_max, valeur_niv FROM __temp__statistique_modele');
