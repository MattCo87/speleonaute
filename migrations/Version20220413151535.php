 ...
 */
final class Version20220413151535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "action" ADD COLUMN localisation INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE "action" ADD COLUMN nombre_cible INTEGER DEFAULT NULL');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__scenario AS SELECT id, lien_formation_id, nom, description, recompense FROM scenario');
        ...
        $this->addSql('INSERT INTO scenario (id, lien_formation_id, nom, description, recompense) SELECT id, lien_formation_id, nom, description, recompense FROM __temp__scenario');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, pseudo, reputation FROM user');
        ...
        $this->addSql('INSERT INTO user (id, email, roles, password, pseudo, reputation) SELECT id, email, roles, password, pseudo, reputation FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__action AS SELECT id, nom, toucher, degat, tier FROM "action"');
        ...
        $this->addSql('INSERT INTO "action" (id, nom, toucher, degat, tier) SELECT id, nom, toucher, degat, tier FROM __temp__action');
