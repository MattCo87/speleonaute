 ...
 */
final class Version20220324145928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE combat (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date_combat DATE NOT NULL, fichier_log VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TABLE formation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL)');
