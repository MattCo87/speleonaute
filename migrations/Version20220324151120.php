 ...
 */
final class Version20220324151120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__combat AS SELECT id, date_combat, fichier_log FROM combat');
        ...
        $this->addSql('INSERT INTO combat (id, date_combat, fichier_log) SELECT id, date_combat, fichier_log FROM __temp__combat');
