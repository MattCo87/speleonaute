 ...
 */
final class Version20220324151318 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__creature AS SELECT id, lien_modele_id, nom, niveau, exp FROM creature');
        ...
        $this->addSql('INSERT INTO creature (id, lien_modele_id, nom, niveau, exp) SELECT id, lien_modele_id, nom, niveau, exp FROM __temp__creature');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__creature AS SELECT id, lien_modele_id, nom, niveau, exp FROM creature');
        $this->addSql('DROP TABLE creature');
        $this->addSql('CREATE TABLE creature (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, lien_modele_id INTEGER DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, niveau INTEGER DEFAULT NULL, exp INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO creature (id, lien_modele_id, nom, niveau, exp) SELECT id, lien_modele_id, nom, niveau, exp FROM __temp__creature');
        $this->addSql('DROP TABLE __temp__creature');
        $this->addSql('CREATE INDEX IDX_2A6C6AF44EA46F32 ON creature (lien_modele_id)');
        $this->addSql('DROP INDEX IDX_31BF745D900DB4E5');
