 ...
 */
final class Version20220324151229 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__creature AS SELECT id, nom, niveau, exp FROM creature');
        $this->addSql('DROP TABLE creature');
        $this->addSql('CREATE TABLE creature (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, lien_modele_id INTEGER DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, niveau INTEGER DEFAULT NULL, exp INTEGER DEFAULT NULL, CONSTRAINT FK_2A6C6AF44EA46F32 FOREIGN KEY (lien_modele_id) REFERENCES modele (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO creature (id, nom, niveau, exp) SELECT id, nom, niveau, exp FROM __temp__creature');
