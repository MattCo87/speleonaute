 ...
 */
final class Version20220324151403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__formation AS SELECT id, nom FROM formation');
        ...
        $this->addSql('INSERT INTO formation (id, nom) SELECT id, nom FROM __temp__formation');
